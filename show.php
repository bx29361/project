...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
        ...
        if (($_GET['startdate'])){
            ...
            $from=$_GET['startdate'];
            $query = "SELECT * FROM information where date = '$from' ";
        ...
        if (($_GET['ito'])){
            ...
            $from=$_GET['ito'];
            $query = "SELECT * FROM information where ito = '$from' ";
...
if (($_GET['ifrom'])){
    ...
    $from=$_GET['ifrom'];
    $query = "SELECT * FROM information where ifrom = '$from' ";
